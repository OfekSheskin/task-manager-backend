...
import app.models  # noqa: F401  — imports every model so autogenerate sees them
...
# Every table Alembic should know about is registered on Base.metadata,
# which is what 'alembic revision --autogenerate' compares against the DB.
