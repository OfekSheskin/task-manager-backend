...
from app.schemas.friendship_schemas import FriendshipCreate, FriendshipResponse, FriendshipUpdate, FriendResponse, PendingRequestResponse
...
@router.get("/pending", response_model=list[PendingRequestResponse], status_code=status.HTTP_200_OK)
